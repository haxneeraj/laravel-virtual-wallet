...
return [
     ...
     */
    'enums' => [
        'currency' => \Haxneeraj\LaravelVirtualWallet\Tests\Enums\CurrencyEnum::class,
        'currency_type' => \Haxneeraj\LaravelVirtualWallet\Tests\Enums\CurrencyTypeEnum::class,
        'transaction_method' => \Haxneeraj\LaravelVirtualWallet\Tests\Enums\TransactionMethodEnum::class,
        'transaction_status' => \Haxneeraj\LaravelVirtualWallet\Tests\Enums\TransactionStatusEnum::class,
        'transaction_type' => \Haxneeraj\LaravelVirtualWallet\Tests\Enums\TransactionTypeEnum::class,
        'wallet_status' => \Haxneeraj\LaravelVirtualWallet\Tests\Enums\WalletStatusEnum::class,
        'wallet_type' => \Haxneeraj\LaravelVirtualWallet\Tests\Enums\WalletTypeEnum::class,
    ],
